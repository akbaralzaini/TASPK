			...
			<div class="col-md-3">
				<div class="pmd-card pmd-card-default pmd-z-depth">
					<div class="pmd-card-media">
						...
						<?php } else { ?>
							<img src="../user/process/foto_peserta/<?= $data_pribadi['foto'] ?>" alt="New User">
						<?php } ?>
					</div>
				...
				<div class="pmd-card pmd-z-depth">
					<div class="pmd-tabs" style="background-color: #8f1102; color:white">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#aboutalss" aria-controls="aboutalss" role="tab" data-toggle="tab">Nilai</a></li>
						</ul>
					</div>
					<div class="pmd-card-body">
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="aboutalss">
									...
									<table class="table pmd-table table-striped">
										<thead>
											<tr>
												...
												<th>
													<input type="text" readonly name="peserta" class="form-control" value="<?= $data_pribadi['email'] ?>">
												</th>
												<th>
													<button type="submit" class="btn btn-primary pmd-ripple-effect">EDIT NILAI</button>
												</th>
											</tr>
										</thead>
										<tbody>
											...
											?>
												<tr>
													...
													<td colspan="2">
														...
														$nilai = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `nilai_sub_kriteria` WHERE `email` = '".$data_pribadi['email']."' AND `id_kriteria` = '".$penilaian['id_kriteria']."'"));
														...
														<?php } else { ?>
															...
															<input type="number" name="<?= $row['nama'] ?>" value="<?= $nilai['nilai'] ?>" class="form-control">
